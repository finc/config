...
class Manager
{
     ...
     * of {@see \Zend\ConfigAggregator\ConfigAggregator} when called. May be
     ...
     *                               {@see Manager::$aggregatedConfigPath}
     *                               and {@see Manager::$demandedConfigPath}
    ...
    {
        return new Config($this->getValue($path) ?? []);
    }
